...
public class SqliteBase {
    ...
    private static volatile SqliteBase sqliteBase;
    private final static String TAG = SqliteBase.class.getSimpleName();
    private SQLiteDatabase database = SqliteBaseOpenHelper.getInstance().getWritableDatabase();

    public static SqliteBase getInstance() {
        if (sqliteBase == null) {
            synchronized (SqliteBase.class) {
                if (sqliteBase == null) {
                    sqliteBase = new SqliteBase();
                }
            }
        }
        return sqliteBase;
